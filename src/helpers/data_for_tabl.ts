  ...
  // Defined rows
  const rows = [{ calories: 159, fat: 6.0, carbs: 24, protein: 4.0, sodium: 87, calcium: '14%', iron: '1%' },
    ...
    // Defined columns
  const columns = [
    { name: 'desc', required: true, label: 'Dessert (100g serving)', align: 'left', field: 'name', format: (val: any) => `${val}`, sortable: true },
